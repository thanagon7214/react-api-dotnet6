    ...
    return (
        <div className="content">
            ...
            <Row style={{marginBottom:'10px'}}>
                <Col md={12}>
                    <Button className='flex items-center'><PlusCircle size={16} color="white" className="inline-block" /><span className="text-th-cus ml-2 inline-block" lang="th"> เพิ่มข้อมูล</span></Button>
